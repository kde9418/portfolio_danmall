	...
	<div class="wrapper">
		<%-- Main content --%>
			<section class="content container-fluid">
				<div class="container" style="width: 80%; min-width: 900px; background-color: white; font-size: 14px;" >
					<form id="joinForm" action="/member/join" method="post">
						<div class="container" style="width: 800px; padding: 5%;">
							<h2 class="form-signin-heading text-center">회 원 가 입</h2>
							<br><br>
							<div class="form-group" style="width:100%;">
								...
								<button id="btn_checkId" class="btn btn-success" type="button">중복 확인</button>
							...
							<div class="form-group">
								<label for="inputPasswordCheck">* 비밀번호 확인</label> <input
									...
									placeholder="비밀번호 확인을 위해 다시 한 번 입력 해 주세요" style="max-width: 630px;" >
							...
							<div class="form-group">
								...
								<label><input type="radio" name="mem_sex" value="M" style="margin-left: 20px;" checked>남자</label>
	      						<label><input type="radio" name="mem_sex" value="F" style="margin-left: 20px;">여자</label>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								- 메일 :
								<label><input type="radio" name="mem_accept_e" value="Y" style="margin-left: 20px;" checked> 예</label>
	      						<label><input type="radio" name="mem_accept_e" value="N" style="margin-left: 20px;"> 아니오</label><br />
	      						- 휴대폰 :
								<label><input type="radio" name="mem_accept_p" value="Y" style="margin-left: 20px;" checked> 예</label>
	      						<label><input type="radio" name="mem_accept_p" value="N" style="margin-left: 20px;"> 아니오</label>
							</div>
						</div>
						<div class="form-group text-center">
							<button type="button" id="btn_submit" class="btn btn-primary" style="margin-right: 20px;">
